...
void apply_saved_settings()
{
    ...
    config.engine.prototype      = s.prototype;
    config.video.fps             = s.fps_mode;
    config.video.widescreen      = s.widescreen;
    config.sound.enabled         = s.sound_on;
    ...
    config.engine.freeplay       = s.freeplay;
    config.engine.fix_bugs       = s.fix_bugs;
    config.engine.new_attract    = s.new_attract;
