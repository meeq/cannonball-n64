...
void Outrun::select_course(bool jap, bool prototype)
{
    ...
    if (jap)
    {
        ...
        adr.pal_music_select      = PAL_MUSIC_SELECT_J;
        ...
        adr.tiles_minicars2       = TILES_MINICARS2_J;
        adr.default_scores        = DEFAULT_SCORES_J;
    ...
    else
    {
        ...
        adr.pal_music_select      = PAL_MUSIC_SELECT;
        ...
        adr.tiles_minicars2       = TILES_MINICARS2;
        adr.default_scores        = DEFAULT_SCORES;
        adr.tiles_alphabet        = TILES_ALPHABET;
        adr.map_route_lookup      = MAP_ROUTE_LOOKUP;
        adr.text1_credit               = TEXT1_CREDIT;
        adr.text1_credits              = TEXT1_CREDITS;
        adr.text1_clear_credits        = TEXT1_CLEAR_CREDITS;
        adr.text1_freeplay             = TEXT1_FREEPLAY;
        adr.text2_coursemap            = TEXT2_COURSEMAP;
        adr.text1_press_start          = TEXT1_PRESS_START;
        adr.text1_clear_start          = TEXT1_CLEAR_START;
        adr.text1_insert_coins         = TEXT1_INSERT_COINS;
        adr.text1_clear_coins          = TEXT1_CLEAR_COINS;
        adr.hud_time1                  = HUD_TIME1;
        adr.hud_time2                  = HUD_TIME2;
        adr.hud_score1                 = HUD_SCORE1;
        adr.hud_score2                 = HUD_SCORE2;
        adr.hud_kph1                   = HUD_KPH1;
        adr.hud_kph2                   = HUD_KPH2;
        adr.hud_stage1                 = HUD_STAGE1;
        adr.hud_stage2                 = HUD_STAGE2;
        adr.hud_one                    = HUD_ONE;
        adr.text2_gameover             = TEXT2_GAMEOVER;
        adr.text2_select_music         = TEXT2_SELECT_MUSIC;
        adr.text1_1986_sega            = TEXT1_1986_SEGA;
        adr.hud_lap1                   = HUD_LAP1;
        adr.hud_lap2                   = HUD_LAP2;
        adr.music_eq_pal               = MUSIC_EQ_PAL;
        adr.text1_copyright            = TEXT1_COPYRIGHT;
        adr.text2_magical              = TEXT2_MAGICAL;
        adr.text2_breeze               = TEXT2_BREEZE;
        adr.text2_splash               = TEXT2_SPLASH;
        adr.text1_yourscore            = TEXT1_YOURSCORE;
        adr.text2_best_or              = TEXT2_BEST_OR;
        adr.text1_score_etc            = TEXT1_SCORE_ETC;
        adr.text2_alphabet             = TEXT2_ALPHABET;
        adr.text1_extend1              = TEXT1_EXTEND1;
        adr.text1_extend2              = TEXT1_EXTEND2;
        adr.text1_extend_clear1        = TEXT1_EXTEND_CLEAR1;
        adr.text1_extend_clear2        = TEXT1_EXTEND_CLEAR2;
        adr.text1_laptime1             = TEXT1_LAPTIME1;
        adr.text1_laptime2             = TEXT1_LAPTIME2;
        adr.text1_laptime_clear1       = TEXT1_LAPTIME_CLEAR1;
        adr.text1_laptime_clear2       = TEXT1_LAPTIME_CLEAR2;
        adr.text1_easter               = TEXT1_EASTER;
        adr.text1_easter_clear         = TEXT1_EASTER_CLEAR;
        adr.text2_bonus_points         = TEXT2_BONUS_POINTS;
        adr.text1_bonus_stop           = TEXT1_BONUS_STOP;
        adr.text1_bonus_sec            = TEXT1_BONUS_SEC;
        adr.text1_bonus_x              = TEXT1_BONUS_X;
        adr.text1_bonus_pts            = TEXT1_BONUS_PTS;
        adr.text1_bonus_100k           = TEXT1_BONUS_100K;
        adr.text2_bonus_clear1         = TEXT2_BONUS_CLEAR1;
        adr.text2_bonus_clear2         = TEXT2_BONUS_CLEAR2;
        adr.text2_bonus_clear3         = TEXT2_BONUS_CLEAR3;
        adr.pass1_offset               = PASS1_OFFSET;
        adr.pass2_offset               = PASS2_OFFSET;
        adr.tiles_minimap              = TILES_MINIMAP;
        adr.tilemap_pals               = TILEMAP_PALS;
        adr.pal_bestor                 = PAL_BESTOR;
        adr.sprite_x_offs              = SPRITE_X_OFFS;
