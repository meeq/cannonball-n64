...
struct adr_t
{
    ...
    uint32_t text1_credits;
    uint32_t text1_clear_credits;
    uint32_t text1_freeplay;
    uint32_t text2_coursemap;
    uint32_t text1_press_start;
    uint32_t text1_clear_start;
    uint32_t text1_insert_coins;
    uint32_t text1_clear_coins;
    uint32_t hud_time1;
    uint32_t hud_time2;
    uint32_t hud_score1;
    uint32_t hud_score2;
    ...
    uint32_t hud_stage2;
    uint32_t hud_one;
    uint32_t text2_gameover;
    uint32_t text2_select_music;
    uint32_t text1_1986_sega;
    uint32_t hud_lap1;
    uint32_t hud_lap2;
    uint32_t music_eq_pal;
    uint32_t text1_copyright;
    uint32_t text2_magical;
    uint32_t text2_breeze;
    uint32_t text2_splash;
    uint32_t text1_yourscore;
    uint32_t text2_best_or;
    uint32_t text1_score_etc;
    uint32_t text2_alphabet;
    uint32_t text1_extend1;
    uint32_t text1_extend2;
    uint32_t text1_extend_clear1;
    uint32_t text1_extend_clear2;
    uint32_t text1_laptime1;
    uint32_t text1_laptime2;
    uint32_t text1_laptime_clear1;
    uint32_t text1_laptime_clear2;
    uint32_t text1_easter;
    uint32_t text1_easter_clear;
    uint32_t text2_bonus_points;
    uint32_t text1_bonus_stop;
    uint32_t text1_bonus_sec;
    uint32_t text1_bonus_x;
    uint32_t text1_bonus_pts;
    uint32_t text1_bonus_100k;
    uint32_t text2_bonus_clear1;
    uint32_t text2_bonus_clear2;
    uint32_t text2_bonus_clear3;
    uint32_t pass1_offset;
    uint32_t pass2_offset;
    uint32_t tiles_minimap;
    uint32_t tilemap_pals;
    uint32_t pal_bestor;
    uint32_t sprite_x_offs;
